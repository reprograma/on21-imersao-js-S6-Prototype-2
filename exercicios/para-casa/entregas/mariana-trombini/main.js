...
client1.addBank(bank2, client1)
client2.addBank(bank, client2)
client2.addBank(bank2, client2)
...
client1.addBank(bank3, client1)
client1.addBank(bank3, client1)
client2.addBank(bank3, client2)
client2.addBank(bank4, client2)

client2.removeBank(bank3)

const client3 = new Client('Mônica', '111.222.333-22')

client3.addBank(bank4, client3)
client3.addBank(bank3, client3)
client3.addBank(bank, client3)
